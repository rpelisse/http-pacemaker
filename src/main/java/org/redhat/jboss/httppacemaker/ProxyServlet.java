...
import static org.redhat.jboss.httppacemaker.utils.ConfigurationUtils.buildURI;
import static org.redhat.jboss.httppacemaker.utils.ConfigurationUtils.retrieveParameterFromContext;
...
import org.redhat.jboss.httppacemaker.utils.ReflectUtils;
 ...
 * </p>
 *
 * <em>This class has been copy from the <a href="https://github.com/dsmiley/HTTP-Proxy-Servlet">HTTP-Proxy-Servlet</a>.</em>
 *
 * @author David Smiley dsmiley@mitre.org
 * @author Romain Pelisse belaran@gmail.com
 */
@WebServlet(displayName="HttpSimpleProxy", loadOnStartup=1, urlPatterns="/simple_proxy/*")
public class ProxyServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;

	/** A boolean parameter name to enable logging of input and target URLs to the servlet log. */
	public static final String P_LOG = "org.redhat.jboss.httppacemaker.log";

	/** The parameter name for the target (destination) URI to proxy to. */
	private static final String P_TARGET_URI = "org.redhat.jboss.httppacemaker.targetUri";
